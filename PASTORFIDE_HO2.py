...
label3 = tk.Label (window, text = 'Course and Section : BSIT 1B', font=('Arial',20,'bold'), fg='red', bg='black',)
...
label6 = tk.Label (window, text = '\tMoney work for me', font=('Arial',20,'bold'), fg='white', bg='green',)
