...
table = ttk.Treeview(window, columns=("ID","Last Name","First Name","Middle Name","BirthYear","Age"), show="headings")
for col in ("ID","Last Name","First Name","Middle Name","BirthYear","Age"):
